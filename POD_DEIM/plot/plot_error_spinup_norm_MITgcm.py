...
spinnorm = np.zeros((52749,2600))
for i in range(2600):
    spinnorm[:,i] = io.read_PETSc_vec('simulation/reduced/MITgcm/POD300DEIM300/PRO/sp' + str(i).zfill(4) + 'ts2879DOP.petsc')

snormDOP= np.zeros(2599)
for i in range(2599):
...
spinnorm = np.zeros((52749,3000))
for i in range(3000):
    spinnorm[:,i] = io.read_PETSc_vec('simulation/MITgcm/sp' + str(i).zfill(4) + 'ts2879DOP.petsc')
...
labels = [r"FOMN",r"FOMDOP",r"36\_3000P300D300N",r"36\_3000P300D300DOP"]
