...
s_deim = io.read_PETSc_vec("reduced_basis/full_trajectory/s_DEIM.petsc")


s_pod = io.read_PETSc_vec("reduced_basis/full_trajectory/s_POD.petsc")
...
plt.legend(["Singular values FS","Singular values of q"],loc='lower left')
#plt.title(r'\textbf{Singularvalues of SVD 12\_3000}',**axis_font)
plt.savefig('singularvalues_full_trajectory.png', bbox_inches='tight')
plt.show()