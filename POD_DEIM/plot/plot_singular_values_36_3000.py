...
s_deim = io.read_PETSc_vec("reduced_basis/full_trajectory/3_snapshots_per_month/s_DEIM.petsc")


s_pod = io.read_PETSc_vec("reduced_basis/full_trajectory/3_snapshots_per_month/s_POD.petsc")
...
plt.savefig('singularvalues_36_3000.png', bbox_inches='tight')
plt.show()